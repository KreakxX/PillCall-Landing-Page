            ...
            <form onSubmit={handleDelete} className="flex flex-col gap-5">
              <div className="flex flex-col gap-4">
                <div className="flex items-start gap-3">
                  ...
                  />
                  <Label htmlFor="understand" className="text-sm leading-relaxed text-foreground">
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <Label htmlFor="dataLoss" className="text-sm leading-relaxed text-foreground">
                    I understand that all my data will be lost and cannot be recovered
                  </Label>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <Label htmlFor="noRecovery" className="text-sm leading-relaxed text-foreground">
              ...
              <div className="flex flex-col gap-3 pt-2 sm:flex-row-reverse">
                ...
                <Button type="button" variant="outline" className="h-11 flex-1 bg-transparent" asChild>
